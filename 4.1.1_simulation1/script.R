...
### Sigma = 1
sd = 1 # change this parameter to replicate the result in Appendix
...
### Combine:
aggresult5000 <- rbind(agg_means1, agg_means2,agg_means3,agg_means4, agg_means5, agg_means10)
colnames(aggresult5000) <- c("beta_cov_aghq","beta_cov_inla","beta_mse_aghq","beta_mse_inla","frailty_cov_aghq","frailty_cov_inla", "frailty_mse_aghq", "frailty_mse_inla")
save(aggresult5000, file = "aggresult5000.Rda")
